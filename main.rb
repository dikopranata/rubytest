...
your_strategy = -> {
  ...
  you = YourPlayer.new(game: game, name: 'Diko Pranata')
...
random_strategy = -> {
  ...
  random_player = RandomPlayer.new(game: game, name: 'Randy 1')
  random_player2 = RandomPlayer.new(game: game, name: 'Randy 2')
